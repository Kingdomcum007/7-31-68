    ...
    <div class="row">
      ...
      <div class="col-sm-6">
        <ol class="breadcrumb float-sm-end">
          ...
          <li class="breadcrumb-item active" aria-current="page">products_list</li>
        </ol>
      </div>
    </div>
    <!--end::Row-->
                ...
                ?>
                  <tr class="align-middle">
                    ...
                    <td>
                      ...
                      <a href="index.php?page=del_product&pro_id=<?php echo $row['pro_id']?>" class="btn btn-danger"
                      onclick="return confirm('Confirm on delete?');">
